    ...
    <>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-emerald-400">Saved Snapshots</h2>
        ...
        {snapshots.length === 0 ? (
          <div className="rounded-xl border border-slate-700 bg-slate-800 p-8 text-center">
            <p className="text-slate-400">No snapshots saved yet</p>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            {snapshots.map((snapshot) => (
              <div
                key={snapshot.id}
                className="rounded-xl border border-slate-700 bg-slate-800 p-5 hover:border-emerald-500/50 transition-colors"
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h3 className="font-medium text-emerald-400">{snapshot.name}</h3>
          ...
          <div className="w-full max-w-md rounded-xl border border-slate-700 bg-slate-800 p-6 shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <textarea
                  className="block w-full rounded-lg border border-slate-600 bg-slate-800 py-2 px-3 text-slate-100 placeholder-slate-500 focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm"
                  rows={3}
